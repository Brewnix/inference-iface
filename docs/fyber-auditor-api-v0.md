...
**Companion:** [notify.operator ↔ shared auditor door](notify-operator-audit-door.md) (site half) · [fyber.privilege_grant v0](privilege-grant-v0.md) (incident elevation; **not** this ticket) · [fyber.incident binding v0](incident-binding-v0.md) (overlay case; tickets stay historical via side index) · [Zero-LLM OPNsense detect → block → receipt loop](zero-llm-opnsense-loop.md)
